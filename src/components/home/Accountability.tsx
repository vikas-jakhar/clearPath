        ...
        <div className='lg:py-24 md:py-20 sm:py-16 py-14'>
            <div className="container my-0.5">
                <div className="flex justify-between lg:flex-row flex-col items-center gap-6 sm:gap-10">
                    <div className="max-w-[543px] w-full flex flex-col items-center lg:items-start">
                        <span className='flex text-deep-blue font-messiri font-normal text-sm w-fit py-2 px-3.5 border border-off-blue bg-light-sky rounded-lg text-center'>Why ClearPath?</span>
